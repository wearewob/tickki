...
const ArrowUpRightIcon = () => (
    <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.66667 11.3333L11.3333 4.66667M11.3333 4.66667H4.66667M11.3333 4.66667V11.3333" stroke="#5E30EB" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
const Pricing: FC = () => {
    ...
    return (
        <section className="w-full relative bg-surface-light flex flex-col items-center justify-center py-[60px] md:py-[100px] px-6 lg:px-[194px] box-border text-center text-[36px] md:text-[48px] text-brand-dark font-heading">
            <div className="w-full flex flex-col items-center gap-10 md:gap-16 max-w-[1280px]">
                <div className="self-stretch overflow-hidden flex flex-col items-center">
                    <div className="flex flex-col items-center gap-4 md:gap-6">
                        <Reveal>
                            <h2 className="self-stretch relative text-3xl md:text-4xl leading-tight font-heading text-text-heading m-0">Start growing today</h2>
                        </Reveal>
                        <Reveal delay={200}>
                            <div className="relative text-[15px] md:text-[16px] leading-[120%] font-body text-text-muted text-center">Choose a plan that fits your support team. Upgrade anytime.</div>
                        </Reveal>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center text-left text-[14px] text-text-muted font-manrope w-full">
                    <div className="flex flex-col items-center gap-8 md:gap-12 w-full">
                        ...
                        <div className="w-full flex flex-col lg:flex-row items-stretch justify-center gap-5 text-[24px] text-brand-dark font-body">
                            ...
                            {/* Pro Plan */}
                            <Reveal delay={400} className="flex-1 w-full lg:max-w-[430px]">
                                <div className="w-full h-full rounded-[20px] bg-surface-muted flex flex-col p-6 relative isolate gap-5 md:gap-6 border border-gainsboro">
                                    <div className="flex flex-col gap-5 md:gap-6 z-[0]">
                                        <div className="flex flex-col">
                                            <h3 className="leading-[120%] m-0 text-[20px]">Pro</h3>
                                        </div>
                                        <div className="flex flex-col gap-3 md:gap-[15.2px] text-[32px]">
                                    ...
                                    <div className="flex flex-col gap-5 md:gap-6 z-[2] text-[14px] flex-1">
                                        ...
                                        <div className="flex flex-col gap-3 md:gap-[15px] text-[14px] text-text-muted">
                                            <span className="leading-[120%] font-semibold">Includes:</span>
                                            <div className="flex flex-col gap-2 md:gap-[7px] text-[14px]">
                                                {[
                                        ...
                                        <div className="flex flex-col gap-2 md:gap-[7px] text-[14px] text-text-muted">
                                            {[
                            ...
                            <Reveal delay={500} className="flex-1 w-full lg:max-w-[430px]">
                                <div className="w-full h-full rounded-[20px] bg-white border border-gainsboro flex flex-col p-6 relative isolate gap-5 md:gap-6 text-[14px] xl:scale-[1.02] z-10">
                                    ...
                                    <div className="flex flex-col gap-5 md:gap-6 z-[0]">
                                        ...
                                        <div className="flex flex-col gap-3 md:gap-[15.2px] text-[30px] text-brand-dark">
                                            <div className="flex items-center gap-2 transition-opacity">
                                    ...
                                    <div className="flex flex-col gap-5 md:gap-6 z-[2] text-brand-dark flex-1 text-[14px]">
                            ...
                            {/* Enterprise Plan */}
                            <Reveal delay={600} className="flex-1 w-full lg:max-w-[430px]">
                                <div className="w-full h-full rounded-[20px] bg-surface-muted flex flex-col p-6 relative isolate gap-5 md:gap-6 border border-gainsboro">
                                    <div className="flex flex-col gap-4 md:gap-6 z-[1] font-manrope">
                                        <div className="flex flex-col">
                                            <h3 className="tracking-[-0.96px] leading-[28.8px] m-0 text-[20px] text-brand-dark">Enterprise</h3>
                                        </div>
                                        <div className="flex flex-col gap-3 md:gap-[15.2px] font-body text-[18px] text-brand-dark">
                                            <span className="text-[24px] md:text-[28px] font-semibold leading-[120%]">Custom pricing</span>
                                            <p className="m-0 text-[14px] text-text-muted leading-[120%] font-medium text-left">
                                                Suitable for small businesses with just one brand
                                            </p>
                                        </div>
                                    ...
                                    <div className="flex flex-col gap-5 md:gap-6 z-[3] text-[14px] text-brand-dark flex-1">
                                        ...
                                        <div className="flex flex-col gap-3 md:gap-[15px] text-[14px] text-text-muted">
                                            ...
                                            <button className="text-brand-primary text-[13px] font-medium leading-[120%] bg-transparent border-0 cursor-pointer p-0 text-left hover:underline">
                                                See more
                                            </button>
                                        </div>
                                    </div>
